...
const filterByCategory = (array, numCategory) => {
...
const Elettromedicali = () => {
  ...
  // const displayNumOfProducts = () => {
  //   if(categoriesSelected.length < 1 ) {
  //     return <p>{products.length} prodotti totali</p>
  //   } else if (categoriesSelected.length >= 1){
  //     return <p>{productsToDisplay.length} prodotti totali</p>
  //   } else {
  //     return <p>...</p>
  //   }
  // }
      ...
      <div className="category-page-container">    
        <div className='wrapper-categories'>
          ...
          {/* {categoriesSelected.length < 1 ? 
            <p>{products.length} prodotti totali</p>
            :
            <p>{productsToDisplay.length} prodotti totali</p>
           } */}
